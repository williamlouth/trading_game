...
def generate_schedule():
    ...
    farmerCount = 0
    farmerLists = [
        [10,120,30,110,20,90,130,10,100,40,110,15,80,25,55],
        [100,15,110,25,130,35,10,120,20,95,30,105,10,90,50],
    ...
    consumerCount = 0
    consumerLists = [
        [80,60,60,20,20,20,60,70,50,10,20,10,70,60,70],
        [20,15,15,80,70,70,30,20,20,80,80,80,40,30,30],
        [50,50,50,40,50,40,80,70,80,30,30,30,30,25,25],
